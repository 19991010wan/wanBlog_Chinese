...
layout: post
title: HTML5&CSS3进阶
date: 2022-08-11 23:00:00 +0300
description: You’ll find this post in your `_posts` directory. Go ahead and edit it and re-build the site to see your changes. # Add post description (optional)
img: html5-css3.jpg # Add image post (optional)
...
当前`<vidio>`元素支持三种视频格式： 尽量使用 **mp4格式**
...
![]({{site.baseurl}}/assets/img/post/HTML&CSS3进阶/audio支持格式.png)
...
![]({{site.baseurl}}/assets/img/post/HTML&CSS3进阶/进度条.png)
